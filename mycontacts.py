...
x = (screen_width/2) - (width/2)	# Calculates the Left position
y = (screen_height/2) - (height/2)	# Calculates the Top position
root.geometry("%dx%d+%d+%d" % (width, height, x, y))
root.resizable(0, 0)
root.config(bg="#6666ff")	# Sets the background colour
